...
-- SELECT * FROM EMP WHERE DEPTNO IN(10) AND NOT JOB = 'MANAGER';
-- SELECT * FROM EMP WHERE DEPTNO = 10 MINUS SELECT * FROM EMP WHERE JOB = 'MANAGER';
-- SELECT * FROM EMP WHERE DEPTNO = 10 INTERSECT SELECT * FROM EMP WHERE NOT JOB = 'MANAGER';